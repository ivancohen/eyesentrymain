...
// import ConditionalItemsManager from "@/components/admin/ConditionalItemsManager"; // REMOVED Import
...
const QuestionFormManager = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* REMOVED ConditionalItemsManager rendering */}
      {/* {currentItem?.id && (
        <ConditionalItemsManager questionId={currentItem.id} />
      )} */}
    </div>
  );
};
