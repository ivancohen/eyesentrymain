...
// Using CommonJS require instead of ESM import to avoid TypeScript compilation issues
const fs = require('fs');
const path = require('path');

// Dynamically load the QuestionService by reading the TypeScript file
// and extracting the Supabase client configuration
async function loadDependencies() {
  try {
    console.log("Loading dependencies...");
    
    // First, we need to load the supabase client
